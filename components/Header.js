  ...
  return (
    <div className="px-5 py-7 bg-black-500 md:p-12 rounded-t-3xl flex flex-col items-center">
      <div className="relative flex flex-col items-center">
        ...
        <p className="text-center text-white text-lg font-normal md:max-w-2xl pt-5"><strong>Dobrodošli u moj digitalni svet!</strong> Ovde možete pročitati nešto više o meni, pogledati neke od prethodnih projekata i kontaktirati me.</p>
        <div className="flex flex-col md:flex-row mt-7 mb-9 gap-5">
          <a href="./Nemanja_Radivojevic_Resume.pdf" target="_blank" download className="bg-green-500 rounded-full px-12 py-5 flex justify-center items-center gap-3 border-2 border-solid border-green-500 font-medium text-black-500 hover:bg-transparent group-hover:text-green-500 hover:scale-90 hover:transition-all hover:shadow-lg hover:shadow-green-500 hover:text-white" >Preuzmite CV <FiDownload className="animate-bounce" /></a>
        ...
        <div className="max-w-2xl w-full flex justify-center">
          <ReactPlayer url='https://www.youtube.com/watch?v=YV65WeJ5gYs' width="95%" className="video-player" />
        </div>
        <div className="flex-col items-center gap-4 absolute left-0 bottom-40 hidden md:flex">
        <a href="https://www.linkedin.com/in/nemanjaradivojevic/" target="_blank" rel="noreferrer"><FaLinkedin className="text-white w-6 h-6 hover:text-gray-400 transition" /></a>
        ...
        <a href="#contact" rel="noreferrer" className="absolute -right-14 bottom-48 font-medium text-basic text-white rotate-90 hover:text-gray-400 transition hidden md:block">Kontaktirajte me</a>
      </div>
    </div>
  )
}
